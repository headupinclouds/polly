...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-10-0-dep-8-0-hid', 'Xcode', ios_version='10.0'),
      ...
      Toolchain('ios-9-3-dep-8-0-hid', 'Xcode', ios_version='9.3'),
      ...
      Toolchain('ios-9-2-dep-8-0-hid', 'Xcode', ios_version='9.2'),
