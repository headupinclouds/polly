...
if platform.system() == 'Darwin':
  toolchain_table += [
      ...
      Toolchain('ios-11-4-dep-8-0-arm64-armv7-hid-sections-cxx11', 'Xcode', ios_version='11.4'),    
      Toolchain('ios-11-4-dep-8-0-arm64-armv7-hid-sections-lto-cxx11', 'Xcode', ios_version='11.4'),
      Toolchain('ios-11-4-dep-8-0-arm64-armv7-hid-sections-lto-cxx11-tiny', 'Xcode', ios_version='11.4'),    
